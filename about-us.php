...
<!-- Mirrored from pixelgeeklab.com/html/realestast/about-us.php by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 01 Sep 2018 16:03:12 GMT -->
				...
				<div class="container">
					...
					<div class="navbar-collapse collapse width">
						<ul class="nav navbar-nav pull-right">
							...
							<li class="dropdown active"><a href="#" class="dropdown-toggle" data-toggle="dropdown">More
									Info</a>
								<ul class="dropdown-menu">
		...
		<div role="main" class="main pgl-bg-grey">
			<section class="pgl-intro">
				<div class="container">
					...
					<div class="owl-carousel pgl-pro-slide pgl-img-slide"
						...
						<div class="item-wrap">
							...
							<div class="item-caption">
								<p>Mauris elementum tempus nisi, vitae ullamcorper sem ultricies vitae.</p>
							</div>
						</div>
						<div class="item-wrap">
					...
					<div class="lead pgl-bg-light text-center">
						<p>Mauris elementum tempus nisi, vitae ullamcorper sem ultricies vitae. Nullam consectetur
							lacinia nisi, quis laoreet magna pulvinar in. Class aptent taciti sociosqu ad litora
							torquent per conubia nostra, per inceptos himenaeos. In hac habitasse platea dictumst. Cum
						...
						<div class="col-md-4 animation">
							<div class="offer-item pgl-bg-light">
								<div class="offer-item-inner">
									...
									<p>Perspiciatis unde omnisiste natus error voluptatem remopa accusantium doloremque
						...
						<div class="col-md-4 animation">
							<div class="offer-item pgl-bg-light">
								<div class="offer-item-inner">
									...
									<p>Unde omnisiste natus error voluptatem remopa accusantium doloremque laudantium,
										totam rem aperiam.</p>
								</div>
							</div>
						</div>
