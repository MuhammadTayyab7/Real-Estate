    ...
    <div class="container" style="margin-top: 100px;">
        ...
        if ($result->num_rows > 0) {
            while ($row = $result->fetch_assoc()) {
                ?>
                <form action="update-employee.php?id=<?php echo $_GET['id'] ?>" method="POST" enctype="multipart/form-data">
                    <div class="form-floating mb-3 mt-3">
                        <input type="text" class="form-control" value="<?php echo $row['name']; ?>" id="name"
                            placeholder="Enter Name" name="name">
                        <label for="name">Name</label>
                    </div>
                    <div class="form-floating mb-3 mt-3">
                        <input onchange="checkEmailExist(this)" value="<?php echo $row['email']; ?>" type="email"
                    ...
                    <div class="form-floating mt-3 mb-3">
                        <input type="password" value="<?php echo $row['password'] ?>" class="form-control" id="password"
