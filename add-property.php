...
<body>
    ...
    <div class="container" style="margin-top: 100px;">
        ...
        <form action="property-insert.php" method="POST" enctype="multipart/form-data">
            <div class="form-floating mb-3 mt-3">
                <input onchange="checkPropertyExist(this)" type="text" class="form-control" id="nameexists" placeholder="Enter Property Name" name="name">
                <label for="name">Name</label>
            </div>
           
            <div class="form-floating mt-3 mb-3">
                <input type="tet" class="form-control" id="password" placeholder="Enter bedrooms" name="bedroom">
                <label for="bedroom">Bedroom</label>
            </div>
            <div class="form-floating mt-3 mb-3">
                <input type="text" class="form-control" id="password" placeholder="Enter bathrooms" name="bathroom">
                <label for="bathroom">Bathroom</label>
            </div>
            <div class="form-floating mt-3 mb-3">
                <input type="text" class="form-control" id="password" placeholder="Enter Price" name="price">
                <label for="price">Price</label>
            </div>
            <div class="form-floating mt-3 mb-3">
                <input type="text" class="form-control" id="password" placeholder="Enter Area" name="area">
            ...
            <select class="form-select mb-3 mt-3" aria-label="" name="city" id="city">
